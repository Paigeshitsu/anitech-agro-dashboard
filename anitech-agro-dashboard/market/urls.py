...
urlpatterns = [
    ...
    path('prices/refresh/', views.refresh_market_prices, name='refresh_market_prices'),
    ...
    path('sell-offers/<int:offer_id>/', views.seller_offer_detail, name='seller_offer_detail'),
