...
from notifications.services import notify_admins_once
...
class NotificationModelTest(TestCase):
    ...
    def test_notify_admins_once_deduplicates_same_snapshot(self):
        ...
        notify_admins_once(
            'notif_test_top_recommendation',
            {'crop': 'Rice', 'score': 88},
            'Top crop recommendation updated',
            'Rice is now the top recommendation.',
            notif_type='info',
            timeout=60,
        )
        notify_admins_once(
