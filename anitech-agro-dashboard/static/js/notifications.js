...
function updateNotifications() {
    ...
    fetch('/notifications/api/')
        ...
        .then(data => {
            ...
            const unreadCount = Number.isInteger(data.unread_count)
                ? data.unread_count
            ...
            if (panel) {
                if (notifications.length === 0) {
                    ...
                    panel.innerHTML = notifications.map(n => {
                        ...
                        else if (n.type === 'success') { icon = 'fa-circle-check'; colorClass = 'text-success'; }
                        else if (n.type === 'error') { icon = 'fa-circle-xmark'; colorClass = 'text-danger'; }
